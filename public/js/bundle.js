...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hpbGxpbmdzIiwiYSI6ImNsdTMxc2Y4bjB0YnUya3BkejNwc2l6NXUifQ.LPZx1bg5a5EjVOIFPtQgRQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/chillings/clu349lmo00r701qs9sys8cmq',
    scrollZoom: false //   center: [-118.244937, 34.057402],
    //   zoom: 10,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include this location
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Logged in successfully!'); // Routing user to the homepage to refresh and show updated nav bar
  ...
  _regeneratorRuntime().mark(function _callee(type, data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          urlFragment = type === 'password' ? 'updateMyPassword' : 'updateMe';
          _context.next = 4;
          return _axios.default.patch("http://localhost:3000/api/v1/users/".concat(urlFragment), data);
...
function () {
  ...
  _regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51P54QbE0LGbea54GKsLz0QLsSHv7kp3Mii62HBd6oWUcgaFXvDTwhwpT6tXGDHLvWZ8yxYP74YSIt17D8FLTBiXh00a6r1u6Ku'); // 1) Get checkout session from endpoint
...
},{"./mapbox":"mapbox.js","./login":"login.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
